...
import { ChevronLeft, ChevronRight, CheckCircle2, Circle, Trophy, Sparkles } from 'lucide-react';
        ...
        <main className="flex-1 min-w-0">
          ...
          <div className="flex items-center justify-between mt-8 pt-6 border-t border-white/10">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-xl text-sm text-white/60 hover:text-white disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
            >
            ...
            <div className="flex gap-2">
              {current.quiz && (
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 rounded-xl text-sm bg-green-500/20 text-green-400 border border-green-500/30 hover:bg-green-500/30 transition-all"
                >
                  <Sparkles className="w-4 h-4" />
                  Quiz ({current.quiz.length} questions)
                </button>
              )}
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-xl text-sm bg-primary-500/20 text-primary-400 border border-primary-500/30 hover:bg-primary-500/30 transition-all"
              >
                {currentIdx === sections.length - 1 ? 'Complete Course' : 'Next'}
